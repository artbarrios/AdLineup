...
namespace AdLineup
{
    ...
    {
        public void Log(string message, string detail, string source)
        {
            ...
            {
                myError.HostName = "Host name not available.";
                myError.User = "User name not available.";
                myError.ApplicationName = "Application name not available.";
            }
