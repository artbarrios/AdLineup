...
namespace AdLineup.Controllers
{
    public class CustomersDataController : ApiController
    {
        ...
        public IHttpActionResult PutCustomer(int id, Customer customer)
        {
            ...
            {
                db.SaveChanges();
                logger.Log("PUT: api/CustomersData/ - CustomerId:" + customer.Id.ToString());
            }
        ...
        public IHttpActionResult PostCustomer(Customer customer)
        {
            ...
            db.SaveChanges();
            logger.Log("POST: api/CustomersData/ - CustomerId:" + customer.Id.ToString());
        ...
        public IHttpActionResult DeleteCustomer(int id)
        {
            ...
            db.SaveChanges();
            logger.Log("DELETE: api/CustomersData/ - CustomerId:" + customer.Id.ToString());
